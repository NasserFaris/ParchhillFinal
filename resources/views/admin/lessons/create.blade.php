        ...
        <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title text-dark">Learning Booklet</h3>
                <span class="float-sm-right"><a href="{{ url('/') }}/lesson" class="btn btn-success btn-sm" >Back</a></span>
              </div> 
                <div class="card-body p0">              
                  {!! Form::open(['action' => 'LessonController@store', 'method'=>'POST', 'files' => true]) !!}
                    ...
                    {{ Form::bsSelect('lessonConstan',$lessonConstan->pluck('name', 'id'),null, ['placeholder'=>'Select lesson','class'=>' form-control']) }}
                    {{ Form::bsText('topic','',['placeholder'=>'Enter topic','autocomplete'=>'off']) }}
                    
                    <div class="form-group row">
                      {{ Form::label('fact of the week', null, ['class' => 'col-sm-3 align-self-center col-form-label']) }}
                      <div class="col-sm-9">
                          {{ Form::text('fact_week', '', array_merge(['class' => 'form-control'], ['placeholder'=>'FACT OF THE WEEK','autocomplete'=>'off'])) }}
                      </div>
                    </div>
                    <div class="form-group row">
                      {{ Form::label('quet of the week', null, ['class' => 'col-sm-3 align-self-center col-form-label']) }}
                      <div class="col-sm-9">
                          {{ Form::text('quote_week', '', array_merge(['class' => 'form-control'], ['placeholder'=>'QUOTE OF THE WEEK','autocomplete'=>'off'])) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group row ">
                      ...
                      <table class="col-md-8">
                        ...
                        <tbody>
                          <tr>
                            <td>{{ Form::text('objective[]', '', array_merge(['class' => 'form-control '], ['placeholder'=>'Objective','autocomplete'=>'off'])) }}</td>
                            <td style="text-align:center" ><a class="btn btn-danger removeRow" >-</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
